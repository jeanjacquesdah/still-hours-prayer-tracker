...
function AuthGate({ accounts, setAccounts, setCurrentUser }) {
  ...
  return (
    <div className="auth-screen"><div className="auth-topbar"><div className="auth-topbar-brand"><span className="brand-mark">🕯️</span><span className="auth-topbar-title">Still Hours</span></div></div><div className="auth-center"><div className="auth-visual" aria-hidden="true"><div className="mock-laptop"><div className="mock-laptop-screen"><div className="mock-topbar"><span></span><span></span><span></span></div><div className="mock-app"><div className="mock-app-title">Prayer requests</div><div className="mock-req-item"><span className="mock-dot mock-dot-mauve"></span><div className="mock-lines"><span className="mock-line-main"></span><span className="mock-line-sub"></span></div></div><div className="mock-req-item"><span className="mock-dot mock-dot-sage"></span><div className="mock-lines"><span className="mock-line-main"></span><span className="mock-line-sub"></span></div></div><div className="mock-req-item"><span className="mock-dot mock-dot-accent"></span><div className="mock-lines"><span className="mock-line-main"></span><span className="mock-line-sub"></span></div></div></div></div><div className="mock-laptop-base"></div></div><div className="mock-phone"><div className="mock-phone-notch"></div><div className="mock-phone-screen"><div className="mock-app-title">Good morning</div><div className="mock-stat-row"><div className="mock-stat-chip"><span className="mock-stat-num">8.1</span><span className="mock-stat-label">hrs</span></div><div className="mock-stat-chip"><span className="mock-stat-num">9%</span><span className="mock-stat-label">goal</span></div></div><div className="mock-bars"><span style={{height:"30%"}}></span><span style={{height:"55%"}}></span><span style={{height:"40%"}}></span><span style={{height:"70%"}}></span><span style={{height:"50%"}}></span><span style={{height:"85%"}}></span></div></div><div className="mock-phone-home"></div></div></div>
